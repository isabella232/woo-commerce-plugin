            ...
            <div class="post-body-content">
                ...
                <?php if (!in_array('show_ad',$notices )) : ?>
                    <div id="cmPlugin" data-method="show_ad" class="updated notice cm-plugin-ad is-dismissible">
                        <p>Campaign Monitor lets you manage your subscriber lists and email campaigns. <a href="https://www.campaignmonitor.com?utm_source=woocommerce-plugin&utm_medium=referral">Send something beautiful today!</a></p>
                    </div>
                <?php endif; ?>
